execute if function projectfight:items/collision/check/block_ahead run return run function projectfight:items/definitions/wet_floor_sign/movement_step/nested_return_1
