...
execute align xyz positioned ~-4.5 ~ ~-4.5 if entity @a[tag=!projectfight.player.dead, tag=projectfight.player.playing, dx=9, dy=0, dz=9] run tag @s add projectfight.items.wet_floor_sign.activated
