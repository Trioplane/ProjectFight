execute if function projectfight:items/collision/check/block_ahead run return run function projectfight:items/definitions/banana_peel/movement_step/nested_return_1
