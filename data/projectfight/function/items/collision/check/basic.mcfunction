...
execute positioned ^ ^ ^0.5 run function projectfight:items/collision/check/basic/nested_execute_0
execute positioned ^ ^ ^1.0 run function projectfight:items/collision/check/basic/nested_execute_1
execute positioned ^ ^ ^1.5 run function projectfight:items/collision/check/basic/nested_execute_2
