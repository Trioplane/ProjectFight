...
execute anchored eyes at @s run function projectfight:items/definitions/landmine/use/nested_execute_0
execute as @n[type=item_display, tag=projectfight.items.temp] run function projectfight:items/definitions/landmine/use/nested_execute_1
summon item_display 0 0 0 {Tags: ["projectfight.items.initial_rotation", "projectfight.items.initial_rotation.temp"]}
execute as @n[type=item_display, tag=projectfight.items.initial_rotation.temp] run function projectfight:items/definitions/landmine/use/nested_execute_2
