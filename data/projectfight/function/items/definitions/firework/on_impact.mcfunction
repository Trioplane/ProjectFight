...
execute as @a[tag=!projectfight.player.dead, tag=projectfight.player.playing, distance=..3] run function projectfight:items/definitions/firework/on_impact/nested_execute_0
data modify storage projectfight:health temp.damage.translation_key set value "projectfight.death.firework"
