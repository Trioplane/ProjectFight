...
execute at @s run function projectfight:items/definitions/banana_peel/movement_step/nested_execute_2
...
execute if score @s projectfight.items.velocity.horizontal matches 1.. run function projectfight:items/definitions/banana_peel/movement_step/nested_execute_3
execute if score @s projectfight.items.velocity.horizontal matches ..-1 run function projectfight:items/definitions/banana_peel/movement_step/nested_execute_4
