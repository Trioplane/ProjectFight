...
execute align xyz positioned ~-2.0 ~ ~-2.0 as @a[tag=!projectfight.player.dead, tag=projectfight.player.playing, dx=4, dy=1.6, dz=4] positioned ~2.0 ~ ~2.0 run function projectfight:items/definitions/landmine/on_impact/nested_execute_0
