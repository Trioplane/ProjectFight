...
execute align xyz positioned ~-0.5 ~ ~-0.5 if entity @a[tag=!projectfight.player.dead, tag=projectfight.player.playing, dx=1, dy=0, dz=1] run function projectfight:items/definitions/landmine/movement_step/nested_execute_5
