...
execute as @a[tag=!projectfight.player.dead, tag=projectfight.player.playing, distance=..6] run function projectfight:items/definitions/crate/on_impact/nested_execute_0
